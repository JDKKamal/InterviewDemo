package com.jdkgroup.customviews.fancydialoglib;
...
new FancyAlertDialog.Builder(this)
                    ...
                    .isCancellable(true)
                    .setIcon(R.drawable.iv_logo, Icon.Visible)
                    .OnPositiveClicked(new FancyAlertDialogListener() {
                        @Override
                        public void OnClick() {
                           AppUtils.showToast(getActivity(), "Finish");
                        }
                    })
                    .OnNegativeClicked(new FancyAlertDialogListener() {
                        @Override
                        public void OnClick() {
                            AppUtils.showToast(getActivity(), "Cancel");
                        }
                    })
                    .build();
*/
