...
public class MainActivity extends AppCompatActivity {
    ...
    private void getStoreCouponData() {
        ...
        Observable.just(retrofit.create(StoreCouponsApi.class)).subscribeOn(Schedulers.computation())
                ...
                }).observeOn(AndroidSchedulers.mainThread()).subscribe(storeCoupons -> handleResults(storeCoupons, ""), this::handleError);
    ...
    private void getcouponData() {
        retrofit.create(StoreCouponsApi.class).getCoupons("topcoupons")
                ...
                .subscribe(storeCoupons -> handleResults(storeCoupons, ""), this::handleError);
    }

    private void handleResults(StoreCoupons storeCoupons, String str) {
        if (storeCoupons.getCoupons() != null) {
            ...
            TextView coupon_count = findViewById(R.id.coupon_count);
            coupon_count.setText(storeCoupons.getTotalCoupons());
            TextView max_cashback = findViewById(R.id.max_cashback);
